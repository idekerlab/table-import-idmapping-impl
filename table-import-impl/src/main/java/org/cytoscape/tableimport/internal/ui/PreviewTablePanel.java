...
public class PreviewTablePanel extends JPanel {
	...
	private void showEditDialog(final int colIdx) {
		...
		attrEditorPanel.setTable(previewTable);
		attrEditorPanel.setColIdx(colIdx);
		...
		//~~
		//	
		attrEditorPanel.addPropertyChangeListener("IdmapLabelSource", new PropertyChangeListener() {
			@Override
			public void propertyChange(PropertyChangeEvent evt) {
				//setListDelimiter(colIdx, (String)evt.getNewValue());
				updatePreviewTable();
